...
echo "$($PSQL "SELECT DISTINCT name FROM teams LEFT JOIN games ON teams.team_id=games.winner_id OR teams.team_id=games.opponent_id WHERE team_id != opponent_id ORDER BY name")"
